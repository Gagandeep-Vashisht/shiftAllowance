    ...
    <>
      <form className={classes.form} onSubmit={confirmHandler}>
        <section
          ...
          style={{ backgroundColor: "#564787" }}
        >
          <div className="container py-7 h-100">
            <div className="row d-flex justify-content-center align-items-center h-100">
              <div>
                <h2 className="mb-1" style={{ color: "white", fontSize: 40 }}>
                  {" "}
                  SHIFT ALLOWANCE
                </h2>
              </div>
              <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                <div
                  ...
                  style={{ borderRadius: "1rem", backgroundColor: "#bec5ad" }}
                >
                  <div className="card-body p-4 text-center">
                    ...
                    <div className="form-outline mb-9">
                      <div className={emailControlClasses}>
                        ...
                        {!formInputsValidity.email && (
                          <p>Please enter a valid company emailId!</p>
                        )}
                      </div>
                    </div>
                    ...
                    <button
                      className={`${classes.reqbtn} btn btn-primary btn-lg btn-block mt-5`}
                      id="reqbtn"
                      type="submit"
                    >
                      REQUEST
                  ...
                  <p style={{ fontSize: 12 }}>
                    ...
                    <Link
                      to="/"
                      style={{ textDecoration: "none", fontFamily: "bold" }}
                    >
                      LOGIN
                    </Link>
                  </p>
                  <div
                    className="incedo-logo"
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <img src={incedologo} width="100" alt="" />
                  </div>
                </div>
              </div>
            </div>
